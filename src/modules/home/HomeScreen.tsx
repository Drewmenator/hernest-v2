      ...
      {loading ? (
        ...
        <>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 12 }}>
            <div onClick={() => useStore.getState().setActiveTab("plan")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="View tasks" style={{ background: "#fff", borderRadius: 12, padding: "10px 8px", textAlign: "center", border: `1px solid ${T.linen}`, cursor: "pointer" }}>
            ...
            <div onClick={() => useStore.getState().setActiveTab("calendar")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="View calendar events" style={{ background: "#fff", borderRadius: 12, padding: "10px 8px", textAlign: "center", border: `1px solid ${T.linen}`, cursor: "pointer" }}>
            ...
            <div onClick={() => useStore.getState().setActiveTab("budget")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="Open budget" style={{ background: "#fff", borderRadius: 12, padding: "10px 8px", textAlign: "center", border: `1px solid ${T.linen}`, cursor: "pointer" }}>
          ...
          {data.urgentSchool > 0 && (
            <div onClick={() => useStore.getState().setActiveTab("plan")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="View school action needed" style={{ display: "flex", gap: 10, padding: "8px 10px", background: `${T.blush}10`, borderRadius: 10, marginBottom: 6, cursor: "pointer" }}>
          ...
          {data.nextTrip && data.daysUntil !== null && data.daysUntil <= 30 && (
            <div onClick={() => useStore.getState().setActiveTab("trips")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="View upcoming trip" style={{ display: "flex", gap: 10, padding: "8px 10px", background: `${T.gold}10`, borderRadius: 10, marginBottom: 6, cursor: "pointer" }}>
          ...
          {data.circleOverdue > 0 && (
            <div onClick={() => useStore.getState().setActiveTab("circle")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="View overdue check-ins" style={{ display: "flex", gap: 10, padding: "8px 10px", background: `${T.gold}10`, borderRadius: 10, marginBottom: 6, cursor: "pointer" }}>
              <span style={{ fontSize: 14, flexShrink: 0 }}>💌</span>
              <p style={{ fontFamily: F.sans, fontSize: 12, color: T.esp, margin: 0 }}>{data.circleOverdue} check-in{data.circleOverdue > 1 ? "s" : ""} overdue</p>
            </div>
          )}
          {data.nextEvent && (
            <div onClick={() => useStore.getState().setActiveTab("calendar")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="View next event" style={{ display: "flex", gap: 10, padding: "8px 10px", background: `${T.sage}10`, borderRadius: 10, marginBottom: 6, cursor: "pointer" }}>
              <span style={{ fontSize: 14, flexShrink: 0 }}>📅</span>
          ...
          <p onClick={() => useStore.getState().setActiveTab("plan")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="See full plan" style={{ fontFamily: F.sans, fontSize: 11, color: T.gold, margin: "8px 0 0", cursor: "pointer", textAlign: "right" }}>See full plan →</p>
        </>
      )}
    </div>
  );
...
function FamilyHQCard() {
  ...
  return (
    <div onClick={() => useStore.getState().setActiveTab("family")} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="Open Family HQ" style={{ background: T.ivory, border: `1px solid ${T.linen}`, borderRadius: 20, padding: "16px", marginBottom: 12, cursor: "pointer" }}>
      ...
      <div onClick={(e) => { e.stopPropagation(); useStore.getState().setActiveTab("cleo"); }} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label="Ask Cleo about your family" style={{ marginTop: 10, padding: "8px 12px", background: `${T.gold}10`, borderRadius: 10, textAlign: "center" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
        {modules.map((m, i) => (
          <div key={i} onClick={() => setActiveTab(m.id)}
            role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label={`Open ${m.label}`}
    ...
    <div style={{ animation: "fadeUp .45s ease both" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 20 }}>
        {[
          ...
          <div key={i} onClick={() => setActiveTab(a.tab)} role="button" tabIndex={0} onKeyDown={onEnterSpace} aria-label={a.label} style={{ background: T.ivory, border: `1px solid ${T.linen}`, borderRadius: 14, padding: "12px 8px", cursor: "pointer", textAlign: "center" }}>
